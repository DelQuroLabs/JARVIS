...
import type {
  Conversation, CrewRun, Idea, MemoryItem, Msg, Routine, Skill, ToolCtx, Trace, ToolCallRecord, Workflow, WorkflowRun,
...
export interface AppApi {
  ...
  applySync: (m: {
    ...
    crewRuns?: CrewRun[]; projects?: Project[];
  }) => void;
